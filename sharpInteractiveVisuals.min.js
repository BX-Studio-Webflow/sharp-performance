...
if(navigator.userAgent.indexOf("HeadlessChrome")==-1){resizeCanvas(windowWidth,windowHeight);finalImageCanvasPG.resizeCanvas(windowWidth,windowHeight);effectImageCanvasPG.resizeCanvas(windowWidth,windowHeight);brightestPixels=findBrightestPixels(imgs[currentImg]);updateImage();}}
